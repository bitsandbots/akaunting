...
return [
    ...
    'cannot_modify_posted_journal_entry' => 'Journal entry :id is posted and immutable. Use LedgerService::reverse() to create a reversing entry.',
    'cannot_modify_terminal_journal_entry' => 'Journal entry :id is in terminal status \':status\' and cannot be modified.',
